...
<head>
    ...
    <title>GRN #{{ $goodsReceipt->grn_number }}</title>
    <style>
        @page {
            margin: 0.5cm;
        }
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div>
                <img src="{{ $organization['logo'] }}" alt="Logo" class="logo">
                <div class="mt-3">
                    <div class="text-bold">{{ $organization['name'] }}</div>
            ...
            <div class="document-info">
                ...
                <div class="document-number">GRN #{{ $goodsReceipt->grn_number }}</div>
                <div>Date: {{ $goodsReceipt->receipt_date->format('M d, Y') }}</div>
                <div>Status: <span class="text-bold">{{ strtoupper($goodsReceipt->status) }}</span></div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col col-6">
                <div class="section">
                    ...
                    <div class="text-bold">{{ $goodsReceipt->purchaseOrder->vendor->name ?? 'N/A' }}</div>
            ...
            <div class="col col-6">
                <div class="section">
                    ...
                    <div>PO #: {{ $goodsReceipt->purchaseOrder->po_number ?? 'N/A' }}</div>
                    <div>PO Date: {{ $goodsReceipt->purchaseOrder->order_date->format('M d, Y') ?? 'N/A' }}</div>
                    <div>Received By: {{ $goodsReceipt->received_by }}</div>
                </div>
            </div>
        </div>
            ...
            <table class="table">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="text-right text-bold">{{ number_format($goodsReceipt->items->sum('total'), 2) }}</td>
                        <td colspan="2"></td>
                    </tr>
                </tfoot>
            </table>
